    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("NeoBytes Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a NeoBytes address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and neobytes: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About NeoBytes Core"), this);
    aboutAction->setStatusTip(tr("Show information about NeoBytes Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for NeoBytes Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your NeoBytes addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified NeoBytes addresses"));
    ...
    openAction->setStatusTip(tr("Open a neobytes: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the NeoBytes Core help message to get a list with possible NeoBytes Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("NeoBytes Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to NeoBytes network", "", count));
}
...
{
    QString strTitle = tr("NeoBytes Core"); // default title
