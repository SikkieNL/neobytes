    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("NeoBytes Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About NeoBytes Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  neobytes-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the NeoBytes in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 NBY, 0.1 NBY, 1 NBY and 10 NBY -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://neobytes.atlassian.net/wiki/display/DOC/PrivateSend\">https://neobytes.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("NeoBytes Core is shutting down...") + "<br /><br />" +
